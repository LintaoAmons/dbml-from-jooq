...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.asEnumDataType(top.oatnil.dbmlfromjooq.demo.generated.enums.MpaaRating.class), this, "");

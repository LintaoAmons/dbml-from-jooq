...
import top.oatnil.dbmlfromjooq.demo.generated.Indexes;
import top.oatnil.dbmlfromjooq.demo.generated.Keys;
...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Integer> RELEASE_YEAR = createField(DSL.name("release_year"), top.oatnil.dbmlfromjooq.demo.generated.Domains.YEAR.getDataType(), this, "");
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.defaultValue(DSL.field("'G'::mpaa_rating", SQLDataType.VARCHAR)).asEnumDataType(top.oatnil.dbmlfromjooq.demo.generated.enums.MpaaRating.class), this, "");

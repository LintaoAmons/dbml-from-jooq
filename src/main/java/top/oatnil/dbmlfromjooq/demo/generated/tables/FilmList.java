...
import top.oatnil.dbmlfromjooq.demo.generated.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.asEnumDataType(top.oatnil.dbmlfromjooq.demo.generated.enums.MpaaRating.class), this, "");

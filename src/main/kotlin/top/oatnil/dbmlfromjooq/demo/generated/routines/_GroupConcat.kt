...
open class _GroupConcat : AbstractRoutine<String>("_group_concat", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB) {
    companion object {
     ...
     */
    fun set__1(field: Field<String?>): _GroupConcat {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<String?>): _GroupConcat {
        setField(_2, field)
        return this
    }
}

...
import top.oatnil.dbmlfromjooq.demo.generated.indexes.FILM_FULLTEXT_IDX
import top.oatnil.dbmlfromjooq.demo.generated.indexes.IDX_FK_LANGUAGE_ID
import top.oatnil.dbmlfromjooq.demo.generated.indexes.IDX_TITLE
import top.oatnil.dbmlfromjooq.demo.generated.keys.FILM_PKEY
import top.oatnil.dbmlfromjooq.demo.generated.keys.FILM__FILM_LANGUAGE_ID_FKEY
...
open class Film(
     ...
     */
    val RELEASE_YEAR: TableField<FilmRecord, Int?> = createField(DSL.name("release_year"), top.oatnil.dbmlfromjooq.demo.generated.domains.YEAR.getDataType(), this, "")
     ...
     */
    val RATING: TableField<FilmRecord, MpaaRating?> = createField(DSL.name("rating"), SQLDataType.VARCHAR.defaultValue(DSL.field("'G'::mpaa_rating", SQLDataType.VARCHAR)).asEnumDataType(top.oatnil.dbmlfromjooq.demo.generated.enums.MpaaRating::class.java), this, "")

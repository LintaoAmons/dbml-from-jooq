...
open class FilmList(
     ...
     */
    val RATING: TableField<FilmListRecord, MpaaRating?> = createField(DSL.name("rating"), SQLDataType.VARCHAR.asEnumDataType(top.oatnil.dbmlfromjooq.demo.generated.enums.MpaaRating::class.java), this, "")
